...
public class UFile {
    ...
    public static String writeToFileServerATTT(InputStream inputStream, String fileName, String folder)
            throws Exception {

        String safeFileName = UString.getSafeFileName(fileName) ;//+ File.pathSeparator + UString.extractFileExt(fileName);
        Calendar cal = Calendar.getInstance();
        String uploadPath = folder  + File.separator + cal.get(Calendar.YEAR)
    ...
    public static String writeToFileServerATTT2(InputStream inputStream, String fileName, String folder)
            throws Exception {
        ...
        String uploadPath = folder  + File.separator + cal.get(Calendar.YEAR)
                + File.separator + (cal.get(Calendar.MONTH) + 1) + File.separator + cal.get(Calendar.DATE)
                + File.separator + cal.get(Calendar.MILLISECOND);
        String uploadPathReturn =   File.separator + cal.get(Calendar.YEAR)
                + File.separator + (cal.get(Calendar.MONTH) + 1) + File.separator + cal.get(Calendar.DATE)
                + File.separator + cal.get(Calendar.MILLISECOND);
        File udir = new File(uploadPath);
        if (!udir.exists()) {
